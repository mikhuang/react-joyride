...
var Component = React.createClass({
    ...
    componentDidUpdate: function (prevProps, prevState) {
        ...
        if (isEqual(props, prevProps) && isEqual(state, prevState)) {
            return; // don't do anything if state/props have not changed
        }
    ...
    /**
     * Resets Joyride. Expects all steps to have been removed
     */
    unbind: function() {
        this.unbindEvents();
        this.reset();
    ...
    _calcPlacement: function () {
        ...
        if (step) {
            ...
            var targetElem = document.querySelector(step.selector);
            if (!targetElem) {
                return; // short circuit instead of fail
            }
            target = targetElem.getBoundingClientRect();
